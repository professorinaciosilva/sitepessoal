export default function AboutSection() {
  return (
    <section className="mt-16 text-center">
      ...
      <p className="text-lg text-gray-700 leading-relaxed max-w-3xl mx-auto mt-4 text-justify">
        Neste site, apresento meus livros disponíveis à venda na Amazon, suporte a dúvidas 
        de alunos por meio de meu contato e todas as minhas redes sociais
        onde publico aulas introdutórias, histórias e fatos interessantes.
      </p>
      <p className="text-lg text-gray-700 leading-relaxed max-w-3xl mx-auto mt-4 text-justify">
